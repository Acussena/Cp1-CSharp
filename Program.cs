...
public class Program
{
        ...
        while (!voltar)
        {
            ...
            try
            {
                switch (opcao)
                {
                    ...
                    case "7": AdoService.CalcularComissaoPedido(); break;
    ...
    static async Task InicializarBanco()
    {
        try
        {
            ...
            // Garante que o banco seja criado (SQLite cria o arquivo se não existir)
            context.Database.EnsureCreated();

            // Para EF Core com Migrations, você poderia usar:
